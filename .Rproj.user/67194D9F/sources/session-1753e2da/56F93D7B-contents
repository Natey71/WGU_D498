...
# Question 1: What is the most common month of usage across each of the cities
...
# Question 2: Find what these bikes are mainly used for, either for work commuters or fun to bike around.
#             Let's assume they are mainly used for work, peak would be 7-9AM and 4-6PM the time average 
#             American commutes to work. I would like to find the number of rides each month that start 
#             during ON-PEAK times and compare the the OFF-PEAK usage. 
...
# Question 3: What is the minimum, median, and maximum ride duration for each of the city by month. 
